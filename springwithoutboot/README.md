...
8. If you choose **SETTER INJECTION**. create setters and getters inside the class. Then open spring.xml file, inside bean class -> default    tag (**property**) has name and value tags. **<property name="patientName" value="ARON"/>** If you have multiple variables create
   multiple properties.  
